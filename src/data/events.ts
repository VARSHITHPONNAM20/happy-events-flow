...
export const events: Event[] = [
  {
    ...
    soldCount: 3200,
    tickets: [
      { id: "t1", name: "General Admission", price: 299, description: "Access to all main stages", available: 1200 },
      { id: "t2", name: "VIP Pass", price: 799, description: "VIP lounge, priority viewing, complimentary drinks", available: 300 },
      { id: "t3", name: "Backstage Experience", price: 1999, description: "Meet the artists, exclusive backstage access", available: 50 },
    ],
  },
  {
    id: "2",
    ...
    soldCount: 1450,
    tickets: [
      { id: "t4", name: "Standard Pass", price: 499, description: "Full conference access, all sessions", available: 400 },
      { id: "t5", name: "Premium Pass", price: 999, description: "Priority seating, workshop access, networking dinner", available: 100 },
      { id: "t6", name: "Executive Pass", price: 1999, description: "All access, private meeting rooms, 1-on-1 mentoring", available: 30 },
    ],
  },
  {
    id: "3",
    ...
    soldCount: 22,
    tickets: [
      { id: "t7", name: "Workshop Seat", price: 399, description: "Full 2-day workshop with materials", available: 8 },
    ],
  },
  {
    id: "4",
    ...
    soldCount: 2100,
    tickets: [
      { id: "t8", name: "General Entry", price: 99, description: "Open standing area", available: 700 },
      { id: "t9", name: "Reserved Seating", price: 199, description: "Covered seating with table", available: 150 },
      { id: "t10", name: "Premium Box", price: 499, description: "Private box for 4, catering included", available: 20 },
    ],
  },
  {
    id: "5",
    ...
    tickets: [
      ...
      { id: "t12", name: "Food & Culture Pass", price: 149, description: "5 food vouchers + workshop access", available: 500 },
    ],
  },
  {
    id: "6",
    ...
    soldCount: 165,
    tickets: [
      { id: "t13", name: "Standard Ticket", price: 299, description: "Entry with one complimentary drink", available: 25 },
      { id: "t14", name: "Dinner & Show", price: 699, description: "3-course dinner, premium seating, 2 drinks", available: 10 },
    ],
  },
];
